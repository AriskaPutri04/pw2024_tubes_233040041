...
$smkn = query("SELECT * FROM smkn WHERE id_akreditasi = 2");
...
<head>
    ...
    <title>SMKN Purwakarata Akreditasi B</title>
    ...
    <div class="container" id="container">
        <div class="row fs-5 SMK">
            <div class="col text-center">
                <h2 class="SMK" style="color:white; text-shadow: 3px 3px 3px royalblue">Data SMKN Purwakarta Akredirasi B</h2>
                <br>
            </div>
    </div>
